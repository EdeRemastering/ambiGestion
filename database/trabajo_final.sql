...
(7, 'Adso', 1, '2024-10-04 05:00:00', 2, 21, 'si', 'no', '2024-10-04 20:16:21', '2024-10-04 20:16:21'),
(8, 'Adso', 1, '2024-10-03 05:00:00', 2, 12, 'si', 'no', '2024-10-04 20:18:38', '2024-10-04 20:18:38'),
(9, 'Adso', 5, '2024-10-29 05:00:00', 2, 25, 'Yes', 'Not', '2024-10-07 19:48:50', '2024-10-07 19:48:50');
...
--
ALTER TABLE `fichas`
  ADD CONSTRAINT `fichas_ibfk_1` FOREIGN KEY (`id_programa_formacion`) REFERENCES `programas` (`id`) ON DELETE CASCADE;
